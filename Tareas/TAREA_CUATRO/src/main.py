...
def mostrar_menu():
    while True:
        print("\nMenú:")
        print("1. Consultar nombres por puntuacion de alergia")
        print("2. Consultar puntuacion por nombres de alergias")
    ...
    # Analisis de la clase EvaluaionEspecifica
    ...
    # Perfilar el código utilizando cProfile para cada método
    ...
    # Analisis de la clase TiposDeAlergias
    ...
    # Perfilar el código utilizando cProfile para el método crearAlergia
    ...
    # Perfilar el código utilizando cProfile para el método imprimirInfo
